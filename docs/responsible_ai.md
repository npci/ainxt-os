...
- [ai_engine](ai_engine.md): quality verification and evaluation testing provide monitoring scores consumed by the due-diligence gate.
- [pipeline_runtime](pipeline_runtime.md): runtime engine and serving infrastructure consume route eligibility and promotion decisions.
