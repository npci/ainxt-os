...
`Actor::from_principal` converts a [`Principal`](security_config_identity.md) from [`security_config_identity`](security_config_identity.md) into a human actor.
...
- [`security_config_identity`](security_config_identity.md) provides the `Principal` type that roots a chain as `Actor::Human`.
...
The module also connects upward to runtime surfaces. For example, [`runtime_engine`](runtime_engine.md) and [`server_serving`](server_serving.md) use authorized Runs to dispatch tools, while [`workforce`](workforce.md) and [`teams`](teams.md) define the roles that become `AgentId.definition` values.
...
- Principal type: [`security_config_identity`](security_config_identity.md)
- Runtime consumers: [`runtime_engine`](runtime_engine.md), [`server_serving`](server_serving.md)
