...
| **Downstream** | [caching_erasure](caching_erasure.md) / [idempotency](idempotency.md) | In-flight requests that were routed to a drained group recover through the existing idempotency-ledger discipline; this module does not reinvent retry safety. |
