...
| `ainxt_types` | [security_config_identity](security_config_identity.md) | `Principal`, `DataClass`, and other shared identity primitives. |
...
- **Downstream**, it gates every dispatch in the [runtime_engine](runtime_engine.md), [server_serving](server_serving.md), and [workforce](workforce.md) surfaces by supplying the current valid credential or a denial reason.
