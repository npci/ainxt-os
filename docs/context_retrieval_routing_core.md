...
- **[ainxt-types](security_config.md)** — `DataClass`, `Principal`, and other security primitives. Clearance is expressed through `DataClass::sensitivity()` and `Principal::clearance`.
...
- [security_config](security_config.md) — `DataClass`, `Principal`, and security primitives.
