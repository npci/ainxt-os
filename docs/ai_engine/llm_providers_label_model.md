...
Stage-2 intent classifier ([`ModelIntentClassifier`](../core_infrastructure/surface_conversation_intelligence.md#modelintentclassifier)).
...
| `ainxt_protocol` | [core_interaction.md](../core_infrastructure/core_interaction.md) | `Event` stream deltas |
| `tokio` | external | `mpsc` channel + current-thread runtime |
| `ainxt_runtime` | [runtime_engine.md](../pipeline_runtime/runtime_engine.md) | Base `Provider` trait extended by adapters |
| `ainxt_convo` | [surface_conversation_intelligence.md](../core_infrastructure/surface_conversation_intelligence.md) | Consumer of `LabelModel` via `ModelIntentClassifier` |
...
- **Upstream**: [`ModelIntentClassifier`](../core_infrastructure/surface_conversation_intelligence.md#modelintentclassifier)
