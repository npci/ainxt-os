...
For details on how the runtime builds `AccessScope` from JWT claims and org-tree membership, see [core_infrastructure.md](../core_infrastructure/core_infrastructure.md) and [runtime_engine.md](../pipeline_runtime/runtime_engine.md).
...
For the event-log subsystem that supplies `source_turn`, see [core_interaction.md](../core_infrastructure/core_interaction.md).
...
For the compliance/redaction subsystem that typically implements the `Redactor` trait, see [governance_compliance.md](../governance_compliance/governance_compliance.md) and [ai_engine.md](ai_engine.md) (safety_guardrails).
...
- [core_infrastructure.md](../core_infrastructure/core_infrastructure.md) — `Principal`, `Role`, and identity primitives.
- [runtime_engine.md](../pipeline_runtime/runtime_engine.md) — how the runtime's `Engine` reads memory for a turn.
- [governance_compliance.md](../governance_compliance/governance_compliance.md) — compliance, redaction, and audit primitives.
