...
| Module | Relationship |
| --- | --- |
| [core_interaction](../core_infrastructure/core_interaction.md) | Provides session/turn abstractions that the served path assembles prompts for. |
| [security_config](../core_infrastructure/security_config.md) | Provides `Principal` and configuration loading used by the control plane. |
