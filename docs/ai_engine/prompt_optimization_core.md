...
- **[core_infrastructure](../core_infrastructure/core_infrastructure.md)** (`ainxt-types`): Provides the `Tier` type used to key results by model complexity class.
...
- [runtime_engine](../pipeline_runtime/runtime_engine.md) — runtime surfaces including `prompt_optimizer_surface`
