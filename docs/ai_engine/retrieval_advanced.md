...
- **security_config_identity / ainxt-types**: provides `Principal`, `DataClass`, and `AccessContext` used for principal-derived RLS and clearance checks. See [security_config_identity.md](../core_infrastructure/security_config_identity.md).
...
- [security_config_identity.md](../core_infrastructure/security_config_identity.md) — `Principal`, `DataClass`, and identity primitives used for RLS and clearance checks.
