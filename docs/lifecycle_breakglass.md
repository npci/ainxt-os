...
- **Cross-cutting concerns:**
  ...
  - [`core_interaction`](core_interaction.md) / [`eventlog`](core_interaction.md#eventlog) — tamper-evident logging infrastructure
...
These properties make the module compatible with the deterministic replay and evaluation infrastructure described in [`evaluation_testing`](evaluation_testing.md).
...
- [`evaluation_testing`](evaluation_testing.md) — deterministic replay and conformance testing
