...
- **[runtime_engine](runtime_engine.md)** / **[surfaces](surfaces.md)** — the runtime surface that orchestrates prompt optimization and consumes the resulting DRAFTs.
...
- Runtime surfaces such as [`prompt_optimizer_surface`](runtime_engine.md) drive the optimization and then call the bridge to land results in the registry.
