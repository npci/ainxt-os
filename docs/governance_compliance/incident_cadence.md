...
- It is called by the **daemon** in [`runtime_engine`](../pipeline_runtime/runtime_engine.md) / [`server_serving`](../pipeline_runtime/server_serving.md), which owns the wall-clock timer loop.
