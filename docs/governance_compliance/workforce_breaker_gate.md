...
| [security_config_identity](../core_infrastructure/security_config_identity.md) | Uses `ainxt_types::DataClass` for PII classification. |
| [scenario_service_breaker](../scenario_service/scenario_service_breaker.md) | Conceptually related adversarial testing, but scoped to scenario/chaos testing rather than role publish gating. |
