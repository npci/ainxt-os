...
- **[`security_config_cryptoagility`](../core_infrastructure/security_config_cryptoagility.md)** — Shares the same vetted RustCrypto `sha2` primitive used across the system. The transparency log does not introduce a new cryptographic dependency category.
...
- **[`security_config_cryptoagility`](../core_infrastructure/security_config_cryptoagility.md)** — System-wide cryptographic algorithm registry.
