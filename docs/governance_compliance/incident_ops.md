...
- **Kill-switch and control-plane** integration (for preemptive response to severe incidents) is handled upstream by the [`identity`](identity.md) authority and [`runtime_engine`](../pipeline_runtime/runtime_engine.md) serving infrastructure.
