...
- **Quality verification:** Confidence scoring consumes [`ReviewFinding`](../ai_engine/quality_verification_judge.md) from the judge subsystem and SAST findings from the pipeline's own SAST stage.
