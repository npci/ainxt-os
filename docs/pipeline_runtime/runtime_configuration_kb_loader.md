...
3. For `.jsonl` files, deserializes [context chunks](../ai_engine/knowledge_retrieval.md) (from `ainxt_context::Chunk`) into fully-typed documents.
...
- **[knowledge_retrieval](../ai_engine/knowledge_retrieval.md)** / **[context_sources](../ai_engine/context_sources.md)** — the JSONL loader reuses `ainxt_context::Chunk` as the on-disk serialization format for pre-chunked corpus entries.
- **[security_config](../core_infrastructure/security_config.md)** / **[core_infrastructure](../core_infrastructure/core_infrastructure.md)** — `DataClass` (from `ainxt_types`) is the classification enum applied to every loaded document.
...
- [knowledge_retrieval](../ai_engine/knowledge_retrieval.md) — retrieval and context subsystems that consume the loaded documents.
- [context_sources](../ai_engine/context_sources.md) — source of `ainxt_context::Chunk` used by the JSONL loader.
