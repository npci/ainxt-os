...
- [`ai_engine::prompt_engineering`](../ai_engine/prompt_engineering.md) supplies the LLM-backed decomposers and structure probes that live behind the pure seams defined here.
- [`ai_engine::knowledge_retrieval`](../ai_engine/knowledge_retrieval.md) provides the real repository import/call graph behind `ModuleGraphSource`.
