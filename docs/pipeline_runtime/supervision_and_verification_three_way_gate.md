...
For the broader judge framework, see [quality_verification_judge](../ai_engine/quality_verification_judge.md).
...
| `JudgeVerdict` | cross-model score | `three_way_gate`, `program_completed` | [quality_verification_judge](../ai_engine/quality_verification_judge.md) |
