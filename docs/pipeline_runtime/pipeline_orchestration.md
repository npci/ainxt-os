...
- **Quality verification:** [`ai_engine_quality_verification_judge`](../ai_engine/quality_verification_judge.md) supplies the independent Judge panel and review oracles used in Tier-2+ turns.
