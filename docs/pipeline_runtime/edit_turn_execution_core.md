...
- Optional LLM review + independent Judge panel seams ([`Reviewer`](../ai_engine/quality_verification.md), [`JudgePanel`](../ai_engine/quality_verification.md)).
...
| [`ainxt_judge`](../ai_engine/quality_verification.md) | `JudgePanel`, `Reviewer`, `JudgeCriteria`, `ReviewFinding`, `PanelVerdict`. |
| [`ainxt_types`](../core_infrastructure/core_infrastructure.md) | `Principal` and capability-based RBAC. |
...
- Independent adjudication from [`quality_verification`](../ai_engine/quality_verification.md) via `ainxt_judge`.
...
- [`quality_verification`](../ai_engine/quality_verification.md) — Judge panel and reviewer abstractions.
