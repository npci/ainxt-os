...
| `ainxt-context` (live source) | [context_retrieval_routing_core](../ai_engine/context_retrieval_routing_core.md) | Provides the real import/call graph behind `ModuleGraphSource` in deployments. |
