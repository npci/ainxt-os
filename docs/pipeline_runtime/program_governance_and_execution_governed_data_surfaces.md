...
This struct is the bridge between the [evaluation_testing](../ai_engine/evaluation_testing.md) module and the serving runtime. For details on how the release controller consumes these values, see [quality_verification](../ai_engine/quality_verification.md) and [canary](../ai_engine/canary.md).
...
See [context_retrieval_routing](../ai_engine/context_retrieval_routing.md) for the underlying graph model.
...
See [synthesis](../ai_engine/quality_verification.md) and [context_retrieval_routing](../ai_engine/context_retrieval_routing.md) for the rederivation semantics.
...
See [nl2sql](../ai_engine/nl2sql.md) and [retrieval_advanced](../ai_engine/retrieval_advanced.md) for the catalog, RLS, and query-planning details.
...
See [retrieval_advanced](../ai_engine/retrieval_advanced.md) for federation, epsilon accounting, and disclosure consent.
...
See [context_sources](../ai_engine/context_sources.md) for artifact storage and embedding models, and [knowledge_retrieval](../ai_engine/knowledge_retrieval.md) for the broader retrieval pipeline.
...
|---------|-------------------|
| Online release controller, quality assessment, synthesis | [quality_verification](../ai_engine/quality_verification.md) |
| Canary traffic split and experimentation | [canary](../ai_engine/canary.md) |
| Context fabric, artifact store, routing | [context_retrieval_routing](../ai_engine/context_retrieval_routing.md) |
| Artifact sources and embedding models | [context_sources](../ai_engine/context_sources.md) |
| NL2SQL schemas and safe query generation | [nl2sql](../ai_engine/nl2sql.md) |
| Structured retrieval, RLS, federation, DP | [retrieval_advanced](../ai_engine/retrieval_advanced.md) |
| Core retrieval (corpus, embedder, reranker) | [retrieval_core](../ai_engine/retrieval_core.md) |
| Surface catalog and tenant overrides | [surface_conversation](../core_infrastructure/surface_conversation.md) |
...
- **Release safety**: `ReleaseControllerConfig` keeps release decisions (promote/rollback/drift) configurable and auditable, linking the [evaluation_testing](../ai_engine/evaluation_testing.md) subsystem to the serving path.
