...
| Crate / Module | Role |
|----------------|------|
| `ainxt-guardrails` | Provides `RailChain`, `GuardrailsConfig`, `GuardrailOutcome`, `RailMode`, plus jailbreak and toxicity rails. See [`ai_engine/safety_guardrails`](ai_engine_safety_guardrails.md). |
| `ainxt-compliance` | Provides `StrongRedactor` for PCI/DLP redaction. See [`governance_compliance/compliance`](governance_compliance_compliance.md). |
...
- [`ai_engine_safety_guardrails.md`](ai_engine_safety_guardrails.md) — `ainxt-guardrails` rail chain and guardrail types.
- [`governance_compliance_compliance.md`](governance_compliance_compliance.md) — `ainxt-compliance` redaction engine.
