...
- [`injection_service`](../injection_service/injection_service.md) — a related service that performs layered guardrail/judge scanning; the breaker can be used to adversarially validate such defenses.
