...
> See [`core_interaction`](core_interaction.md) for documentation of the `ainxt-cache` crate (`PartitionedCache`, `CacheConfig`, `CacheHit`).
...
- The platform DPDP erasure cascade (via [`ErasureParticipant`]) — see [`governance_compliance`](governance_compliance.md) and [`lifecycle`](lifecycle.md).
...
- [`core_interaction`](core_interaction.md) (`ainxt-cache`) for the `PartitionedCache` answer/prompt-prefix tiers.
