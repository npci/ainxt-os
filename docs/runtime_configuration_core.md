...
- **Upstream config loading** — [`security_config`](security_config.md) (`ainxt-config::Loader`) parses `config.toml` into [`RuntimeConfig`](security_config.md).
- **Downstream engine execution** — [`core_engine`](core_engine.md) (`ainxt-runtime::Engine`) runs turns.
- **Downstream surfaces** — [`surface_conversation`](surface_conversation.md) / [`chat_identity`](chat_identity.md) / [`workforce_surface`](workforce_surface.md) provide profiled chat, identity-governed chat, and workforce studio surfaces.
...
- **Cross-cutting subsystems** — [`memory_management`](memory_management.md), [`knowledge_retrieval`](knowledge_retrieval.md), [`governance_compliance`](governance_compliance.md), and [`ai_engine`](ai_engine.md).
...
- **Configuration loading & base types**: [security_config](security_config.md)
- **Core turn engine**: [core_engine](core_engine.md)
- **Profiled chat surfaces**: [surface_conversation](surface_conversation.md)
- **Identity-governed chat**: [chat_identity](chat_identity.md)
- **Workforce studio surface**: [workforce_surface](workforce_surface.md)
- **Prompt optimizer surface**: [prompt_optimizer_surface](prompt_optimizer_surface.md)
...
- **Knowledge retrieval & RAG**: [knowledge_retrieval](knowledge_retrieval.md)
- **AI engine (prompts, guardrails, providers, judges)**: [ai_engine](ai_engine.md)
- **Governance & compliance (incident, lifecycle, payments, identity)**: [governance_compliance](governance_compliance.md)
- **Connectors & MCP**: [connectors](connectors.md)
