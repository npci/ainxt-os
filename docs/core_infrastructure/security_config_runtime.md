...
- [`ai_engine_safety_guardrails`](../ai_engine/safety_guardrails.md) for `guardrails` and `injection` config.
- [`ai_engine_prompt_engineering`](../ai_engine/prompt_engineering.md) for `prompt`, `policy`, and `steerability` config.
- `core_interaction_telemetry` for `telemetry` config.
...
- `guardrails` → [`ai_engine_safety_guardrails`](../ai_engine/safety_guardrails.md)
- `injection` → [`ai_engine_safety_guardrails`](../ai_engine/safety_guardrails.md) (prompt-injection defense)
- `prompt` / `policy` / `steerability` → [`ai_engine_prompt_engineering`](../ai_engine/prompt_engineering.md)
...
- **Downstream:** `RuntimeConfig` is consumed by [`pipeline_runtime`](../pipeline_runtime/pipeline_runtime.md) components such as `ainxt-runtime`, `ainxt-runtimed`, `ainxt-server`, and `ainxt-serving` to make routing, gating, and budgeting decisions.
...
- [`ai_engine_safety_guardrails`](../ai_engine/safety_guardrails.md) — implementation of `guardrails` and `injection` config.
- [`ai_engine_prompt_engineering`](../ai_engine/prompt_engineering.md) — implementation of `prompt`, `policy`, and `steerability` config.
- `core_interaction_telemetry` — implementation of `telemetry` config and cost attribution.
- [`pipeline_runtime`](../pipeline_runtime/pipeline_runtime.md) — the runtime engine and serving layer that consume `RuntimeConfig`.
