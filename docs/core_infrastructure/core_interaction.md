...
- [runtime_engine](../pipeline_runtime/runtime_engine.md) — the turn handler, model routing, serving gates, and program execution surfaces.
- [application_runtime](application_runtime.md) — chat surfaces, conversation management, skills, plugins, and WASM sandboxing.
- [ai_engine](../ai_engine/ai_engine.md) — providers, prompts, retrieval, memory, synthesis, and evaluation.
- [governance_compliance](../governance_compliance/governance_compliance.md) — admission, compliance sweeps, incidents, lifecycle, and responsible AI.
