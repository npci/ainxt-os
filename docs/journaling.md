...
- **Breaker differential** — emits `BreakerDifferential` during Tier-3 invariant/differential runs. See [pipeline orchestration](pipeline_orchestration.md) and the broader [scenario service](scenario_service.md) for breaker concepts.
