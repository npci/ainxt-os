...
- Serving infrastructure (e.g., [`server_serving`](server_serving.md), [`runtime_engine`](runtime_engine.md)) — ultimately routes requests according to the git-ref returned by [`TrafficSplit::route`](#trafficsplit) and the live pointer maintained by [`PointerController`](#pointercontroller-trait).
