...
The runtime's [Program Governance and Execution](program_governance_and_execution.md) module
...
`QuotedContent` and rejected). The [Lifecycle](lifecycle.md) module's retention policies govern raw
...
- [Lifecycle](lifecycle.md) — retention policies, raw feedback TTL, right-to-erasure
- [Program Governance and Execution](program_governance_and_execution.md) — `LearningSink`, `LearningRecord` → flywheel capture
