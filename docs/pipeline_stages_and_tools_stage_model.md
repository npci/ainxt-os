...
### [`quality_verification_judge`](quality_verification_judge.md)
...
- [`quality_verification_judge`](quality_verification_judge.md) — independent LLM review that feeds the `LlmReview` stage.
