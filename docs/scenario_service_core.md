...
- **[core_interaction](core_interaction.md)** — for session/turn abstractions (`SessionManager`, `TurnInput`, `EventEnvelope`).
- **[ai_engine](ai_engine.md)** — for model output, guardrails, and answer quality.
- **[pipeline_runtime](pipeline_runtime.md)** — for the production execution path.
...
- **[core_interaction](core_interaction.md)** — session/turn protocol abstractions consumed by future runtime targets.
- **[ai_engine](ai_engine.md)** — model output, guardrails, and quality assessment used by production targets.
- **[pipeline_runtime](pipeline_runtime.md)** — production execution surfaces that will eventually implement `Target`.
