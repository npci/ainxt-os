...
1. **Connector Runtime** â€” the policy spine that every outbound action must pass through.
2. **HTTP Connectors** â€” concrete adapters and an air-gap-aware HTTP transport that sit on top of the runtime.
3. **MCP Runtime** â€” transport-agnostic discovery, ranking, routing, and trust-on-first-use pinning for MCP servers.
...
### AI Engine ([ai_engine](ai_engine.md))
...
### Pipeline / Runtime ([pipeline_runtime](pipeline_runtime.md))
...
- [connectors_runtime.md](connectors_runtime.md) â€” policy spine and safety seams
- [connectors_http.md](connectors_http.md) â€” HTTP adapters, transport, and OAuth lifecycle
- [connectors_mcp.md](connectors_mcp.md) â€” MCP discovery, ranking, routing, and pinning
- [security_config.md](security_config.md) â€” identity, OAuth, token storage, and data classification
- [ai_engine.md](ai_engine.md) â€” injection provenance and guardrails
- [application_runtime.md](application_runtime.md) â€” tool registry and capability dispatch
- [pipeline_runtime.md](pipeline_runtime.md) â€” runtime engine and server surfaces
