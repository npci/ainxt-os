...
| `THIRD_PARTY_NOTICES.md` | 3 | DOMPurify (×2) and `aws-lc-rs` (Apache-2.0 AND ISC). |
...
(`deny.toml`), generated dependency inventories, genuine third-party notices (DOMPurify, aws-lc-rs),
