...
async fn bootstrap_outsourcing(app: &App) -> Result<(), String> {
    ...
    let payload = serde_json::json!({
        "id": "outsourcing.cloud.claude-sonnet-4-6",
        "provider_legal_entity": "Anthropic",
        "permitted_data_class": "public",
        "data_residency": "in",
        "exit_plan_ref": "claude-exit-plan",
        "concentration_tag": "cloud-ai",
        "contract_ref": "anthropic-contract",
        "board_approval_ref": "board-approval-claude",
    ...
    println!("ainxt-os: Claude outsourcing registration bootstrapped");
    Ok(())
}
