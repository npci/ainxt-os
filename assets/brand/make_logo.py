...
Uses Unicode braille (U+2800), which packs a 2x4 dot grid per character
cell — 2x the horizontal and 4x the vertical resolution of half-blocks, so
small marks stay legible. A terminal UI can recolor the art with a single
gray->white sheen, so only the silhouette matters: we isolate the bright
